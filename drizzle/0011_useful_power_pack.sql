...
ALTER TABLE "user_community_roles" ADD CONSTRAINT "user_community_roles_user_community_id_user_communities_id_fk" FOREIGN KEY ("user_community_id") REFERENCES "public"."user_communities"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
CREATE UNIQUE INDEX "user_community_role_unique_idx" ON "user_community_roles" USING btree ("user_community_id","role_id");--> statement-breakpoint
